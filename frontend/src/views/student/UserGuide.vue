<template>
  <div class="page-content">
    ...
    <div class="card contact-card">
      ...
      <p class="contact-sub">Imaš pitanje ili problem? Javi nam se!</p>
      <a href="mailto:info@doregym.hr" class="btn-primary" style="display:block;text-align:center;padding:12px;border-radius:10px;background:var(--blue);color:#fff;font-weight:700;font-size:14px;margin-top:12px;">
        Pošalji email
      </a>
    </div>
  </div>
...
const sections = [
  {
    ...
    a: 'Idi na tab "Rezervacije", odaberi datum i pritisni "Prijavi se" na željeni termin. Rezervacija se potvrđuje odmah.'
  },
  {
    q: 'Kako se odjaviti s termina?',
    a: 'U sekciji "Moje rezervacije" ili direktno na terminu pritisni "Odjavi se". Odjaviš se najkasnije 2h prije termina.'
  },
  {
  ...
  },
  {
    ...
    a: 'Molimo te da se odjaviš ako ne možeš doći, kako bi oslobodio mjesto za drugog korisnika.'
  },
  {
  ...
  {
    q: 'Cijena plana (FAQ)',
    a: 'Rezervacija termina je uključena u tvoju članarinu. Nema dodatnih naknada.'
  },
]
</script>
