<template>
  <section class="card kvarovi-card">
    ...
    <div v-if="kvaroviStore.kvarovi.length === 0" class="empty-state">
...
const props = defineProps({
  showMarkResolved: { type: Boolean, default: true },
  showReportForm: { type: Boolean, default: true }
})
...
async function oznaciPopravljeno(id) {
  if (!props.showMarkResolved) return
